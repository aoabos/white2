...
function(e, t) {
	...
	ae.fn = ae.prototype = {
		...
		map: function(e, t, r) {
			var i, o = 0,
				...
				s = n(e),
				u = [];
			if (s) for (; o < a; o++) null != (i = t(e[o], o, r)) && (u[u.length] = i);
			else for (o in e) null != (i = t(e[o], o, r)) && (u[u.length] = i);
			return Z.apply([], u)
		},
		guid: 1,
		proxy: function(e, n) {
		...
		if (!U) if (U = ae.Deferred(), "complete" === V.readyState) setTimeout(ae.ready);
		else if (V.addEventListener) V.addEventListener("DOMContentLoaded", be, !1), e.addEventListener("load", ae.ready, !1);
		else {
	...
	ae.Callbacks = function(e) {
			...
			p = {
				...
				remove: function() {
					return l && ae.each(arguments, function(e, t) {
						for (var n;
						(n = ae.inArray(t, l, n)) > -1;) l.splice(n, 1), o && (n <= s && s--, n <= u && u--)
					}), this
				},
				has: function(e) {
		...
		return f.style.backgroundClip = "content-box", f.cloneNode(!0).style.backgroundClip = "", t.clearCloneStyle = "content-box" === f.style.backgroundClip, ae(function() {
			...
			a && (n = V.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", a.appendChild(n).appendChild(f), f.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", i = f.getElementsByTagName("td"), i[0].style.cssText = "padding:0;margin:0;border:0;display:none", l = 0 === i[0].offsetHeight, i[0].style.display = "", i[1].style.display = "none", t.reliableHiddenOffsets = l && 0 === i[0].offsetHeight, f.innerHTML = "", f.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", t.boxSizing = 4 === f.offsetWidth, t.doesNotIncludeMarginInBodyOffset = 1 !== a.offsetTop, e.getComputedStyle && (t.pixelPosition = "1%" !== (e.getComputedStyle(f, null) || {}).top, t.boxSizingReliable = "4px" === (e.getComputedStyle(f, null) || {
				width: "4px"
			}).width, r = f.appendChild(V.createElement("div")), r.style.cssText = f.style.cssText = o, r.style.marginRight = r.style.width = "0", f.style.width = "1px", t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null) || {}).marginRight)), void 0 !== f.style.zoom && (f.innerHTML = "", f.style.cssText = o + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === f.offsetWidth, f.style.display = "block", f.innerHTML = "<div></div>", f.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== f.offsetWidth, a.style.zoom = 1), a.removeChild(n), n = f = i = r = null)
		}), n = i = s = o = r = a = null, t
	}();
	var we = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
		Te = /([A-Z])/g;
	...
	var Ne, Ce, ke = /[\t\r\n]/g,
		Ee = /\r/g,
		Se = /^(?:input|select|textarea|button|object)$/i,
		Ae = /^(?:a|area)$/i,
	...
	ae.fn.extend({
		...
		toggleClass: function(e, t) {
			...
			return ae.isFunction(e) ? this.each(function(n) {
				...
				if ("string" === n) for (var i, o = 0, a = ae(this), s = t, u = e.match(ue) || []; i = u[o++];) s = r ? s : !a.hasClass(i), a[s ? "addClass" : "removeClass"](i);
	...
	ae.event = {
		...
		trigger: function(n, r, i, o) {
			...
			if (s = u = i = i || V, 3 !== i.nodeType && 8 !== i.nodeType && !Fe.test(h + ae.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."), h = g.shift(), g.sort()), c = h.indexOf(":") < 0 && "on" + h, n = n[ae.expando] ? n : new ae.Event(h, "object" == typeof n && n), n.isTrigger = !0, n.namespace = g.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : ae.makeArray(r, [n]), p = ae.event.special[h] || {}, o || !p.trigger || !1 !== p.trigger.apply(i, r))) {
				...
				for (a = 0;
				(s = d[a++]) && !n.isPropagationStopped();) n.type = a > 1 ? l : p.bindType || h, f = (ae._data(s, "events") || {})[n.type] && ae._data(s, "handle"), f && f.apply(s, r), (f = c && s[c]) && ae.acceptData(s) && f.apply && !1 === f.apply(s, r) && n.preventDefault();
		...
		dispatch: function(e) {
			...
			if (u[0] = e, e.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, e)) {
				...
				(a = o.handlers[r++]) && !e.isImmediatePropagationStopped();) e.namespace_re && !e.namespace_re.test(a.namespace) || (e.handleObj = a, e.data = a.data, (i = ((ae.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, u)) !== t && !1 === (e.result = i) && (e.preventDefault(), e.stopPropagation()));
	...
	}, ae.removeEvent = V.removeEventListener ?
	function(e, t, n) {
		...
		function g(e) {
			...
			}]; s < i; s++) if (n = T.relative[e[s].type]) d = [f(p(d), n)];
			else {
		...
		function b() {}
		var x, w, T, N, C, k, E, S, A, j, D, L, H, M, q, _, F, O = "sizzle" + -new Date,
			B = e.document,
			P = {},
			R = 0,
			W = 0,
		...
		C = a.isXML = function(e) {
			...
			}), T.find.TAG = P.tagNameNoComments ?
			function(e, t) {
			...
			}), H = new RegExp(H.join("|")), M = new RegExp(M.join("|")), _ = n(D.contains) || D.compareDocumentPosition ?
			function(e, t) {
	...
	var Ie = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
		...
		it = p(V),
		ot = it.appendChild(V.createElement("div"));
	rt.optgroup = rt.option, rt.tbody = rt.tfoot = rt.colgroup = rt.caption = rt.thead, rt.th = rt.td, ae.fn.extend({
		...
		buildFragment: function(e, t, n, r) {
			for (var i, o, a, s, u, l, c, f = e.length, d = p(t), h = [], g = 0; g < f; g++) if ((o = e[g]) || 0 === o) if ("object" === ae.type(o)) ae.merge(h, o.nodeType ? [o] : o);
			else if (Ge.test(o)) {
	...
	var Tt = /%20/g,
		Nt = /\[\]$/,
		Ct = /\r?\n/g,
		kt = /^(?:submit|button|image|reset)$/i,
			...
			var i, o, a, s, u, l, c, f, p = ae.ajaxSetup({}, n),
				...
				T = {
					...
					statusCode: function(e) {
						var t;
						if (e) if (x < 2) for (t in e) y[t] = [y[t], e[t]];
	...
	ae.ajaxSettings.xhr = e.ActiveXObject ?
	function() {
			...
			return {
				send: function(i, o) {
					...
					u.send(n.hasContent && n.data || null), r = function(e, i) {
						var s, l, c, f, p;
						try {
							if (r && (i || 4 === u.readyState)) if (r = t, a && (u.onreadystatechange = ae.noop, Vt && delete zt[a]), i) 4 !== u.readyState && u.abort();
							else {
	...
	ae.Animation = ae.extend(P, {
		...
		stop: function(e, n, r) {
			...
			return "string" != typeof e && (r = n, n = e, e = t), n && !1 !== e && this.queue(e || "fx", []), this.each(function() {
				...
				else for (n in a) a[n] && a[n].stop && Kt.test(n) && i(a[n]);
		...
		setOffset: function(e, t, n) {
			...
			var i, o, a = ae(e),
				...
				u = ae.css(e, "top"),
				l = ae.css(e, "left"),
				c = ("absolute" === r || "fixed" === r) && ae.inArray("auto", [u, l]) > -1,
				f = {},
				p = {};
...
$(window).load(function() {
	var b = document.getElementById("post-body").scrollHeight + 300,
		s = 0;
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
	...
	a.
	function = e.languages.bash.
	function, a.keyword = e.languages.bash.keyword, a.boolean = e.languages.bash.boolean, a.operator = e.languages.bash.operator, a.punctuation = e.languages.bash.punctuation
}(Prism), Prism.languages.git = {
	comment: /^#.*/m,
	deleted: /^[-鈥揮.*/m,inserted:/^\+.*/m,string:/("|')(\\?.)*?\1/m,command:{pattern:/^.*\$ git .*$/m,inside:{parameter:/\s(--|-)\w+/m}},coord:/^@@.*@@$/m,commit_sha1:/^commit \w{40}$/m},Prism.languages.http={"request-line":{pattern:/^(POST|GET|PUT|DELETE|OPTIONS|PATCH|TRACE|CONNECT)\b\shttps?:\/\/\S+\sHTTP\/[0-9.]+/m,
	inside: {
